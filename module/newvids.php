<div id="feedmodule-PRO" class="feedmodule-anchor" bis_skin_checked="1">
		...
		<div class="fm2-title-border-box-blue yt-rounded" bis_skin_checked="1">
			<div class="fm2-title" bis_skin_checked="1">
				<img class="img_feed_promoted master-sprite fm2-icon" src="https://web.archive.org/web/20090620134647im_/http://s.ytimg.com/yt/img/pixel-vfl73.gif">
				<span class="fm2-titleText" id="feed_promoted-titleText">New Videos</span>
			</div>
	</div>
	</div>
	</div>
	<div class="clear feedmodule-border-blue yt-rounded" id="feed_promoted-content" bis_skin_checked="1">
		...
		<div class="opt-box-top" bis_skin_checked="1">
			<img class="homepage-ajax-sprite img-php-opt-box-caret" src="https://web.archive.org/web/20090620134647im_/http://s.ytimg.com/yt/img/pixel-vfl73.gif">
		</div>
...
Saving...
		...
		<?php $vids=mysqli_query($sql, "SELECT * FROM `video` WHERE DELETED = 0 ORDER BY `id` DESC LIMIT 6");
	...
	<div class="video-entry" bis_skin_checked="1">
		...
		<div class="video-main-content" id="video-main-content-EhnLzvc1W2w" bis_skin_checked="1">
			...
			<div class="video-facets" bis_skin_checked="1">
					...
					<span id="video-added-time-EhnLzvc1W2w" class="video-date-added"><?= time_elapsed_string($vid['date']) ?></span>
