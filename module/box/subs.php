<div class="headerRCBox">
	...
	<div class="headerTitle">
		<div class="headerTitleRight">(<a href="/profile_subscribers?user=<?php echo htmlspecialchars($username) ?>" class="headers" />View All Subscribers</a>)</div>
		<span>Subscribers (<?php echo $user['subs'] ?>)</span>
	</div></div>
</div>
